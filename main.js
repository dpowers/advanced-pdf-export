...
`)}function ie(n){return n.replace(/^---[ \t]*\r?\n[\s\S]*?\r?\n---[ \t]*(\r?\n|$)/,"")}function le(n){return n.split(/^\/\/\/\s*$/m).map(i=>i.trim()).filter(Boolean)}async function se(n,i,t,e){let o=document.createElement("div");return await d.MarkdownRenderer.render(n,i,o,t,e),ce(o),o.innerHTML}function de(n){return n.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function ce(n){let i=new Map;n.querySelectorAll("h1,h2,h3,h4,h5,h6").forEach(t=>{var l;let e=t.textContent||"",o=de(e);if(!o)return;let s=(l=i.get(o))!=null?l:0;i.set(o,s+1),t.id=s===0?o:`${o}-${s}`}),n.querySelectorAll("a").forEach(t=>{t.classList.remove("external-link")}),n.querySelectorAll(".copy-code-button").forEach(t=>t.remove()),n.querySelectorAll(".callout").forEach(t=>{t.removeAttribute("data-callout-fold"),t.classList.remove("is-collapsed"),t.querySelectorAll(".callout-fold").forEach(e=>e.remove())})}function pe(n){let i=n.replace(/^#([\da-f])([\da-f])([\da-f])$/i,(l,r,a,c)=>`#${r}${r}${a}${a}${c}${c}`);if(!/^#[\da-f]{6}$/i.test(i))return 1;let t=l=>l<=.04045?l/12.92:((l+.055)/1.055)**2.4,e=t(parseInt(i.slice(1,3),16)/255),o=t(parseInt(i.slice(3,5),16)/255),s=t(parseInt(i.slice(5,7),16)/255);return .2126*e+.7152*o+.0722*s}function me(n,i=!1){let t=n.headingScale,e=n.fontFamily==="__custom__"?n.customFontName.trim()||"inherit":n.fontFamily,o=pe(n.tableHeaderBg)<.35?"#fff":n.headingColor;return`
  ...
  `.trim()}var ge=new Set(["P","LI","BLOCKQUOTE","TD","TH"]),he=new Set(["P","DIV","SECTION","ARTICLE","ASIDE","NAV","HEADER","FOOTER","UL","OL","LI","TABLE","THEAD","TBODY","TFOOT","TR","TD","TH","PRE","BLOCKQUOTE","HR","IMG","H1","H2","H3","H4","H5","H6"]),fe=new Set(["CODE","IMG","HR","H1","H2","H3","H4","H5","H6"]),ue=2;function be(n,i){i.innerHTML="";for(let t of n)i.appendChild(t.cloneNode(!0));return i.getBoundingClientRect().height}function we(n,i,t){return e=>be([...n,e],i)<=t-ue}function xe(n){var t;let i=document.createTreeWalker(n,NodeFilter.SHOW_TEXT);for(;i.nextNode();){let e=i.currentNode,o=((t=e.textContent)!=null?t:"").replace(/^\s+/,"");if(o!==e.textContent&&(e.textContent=o),o.length>0)break}}function I(n,i){var p,h;let t=document.createTreeWalker(n,NodeFilter.SHOW_TEXT),e=0,o=null,s=0;for(;t.nextNode();){let f=t.currentNode,b=(h=(p=f.textContent)==null?void 0:p.length)!=null?h:0;if(e+b>=i){o=f,s=i-e;break}e+=b}if(!o)return null;let l=document.createRange();l.selectNodeContents(n),l.setEnd(o,s);let r=document.createRange();r.selectNodeContents(n),r.setStart(o,s);let a=n.cloneNode(!1);a.appendChild(l.cloneContents());let c=n.cloneNode(!1);return c.appendChild(r.cloneContents()),xe(c),[a,c]}function ye(n){let i=[],t=/\s+/g,e;for(;e=t.exec(n);)e.index>0&&e.index<n.length&&i.push(e.index);return i}function Te(n,i,t){var a;let e=(a=n.textContent)!=null?a:"";if(e.length<2)return null;let o=ye(e);if(o.length>0){let c=0,p=o.length-1,h=-1;for(;c<=p;){let f=Math.floor((c+p)/2),b=I(n,o[f]);if(!b){p=f-1;continue}i(b[0])?(h=f,c=f+1):p=f-1}if(h>=0)return I(n,o[h]);if(!t)return null}let s=1,l=e.length-1,r=0;for(;s<=l;){let c=Math.floor((s+l)/2),p=I(n,c);if(!p){l=c-1;continue}i(p[0])?(r=c,s=c+1):l=c-1}return r>0?I(n,r):null}function j(n,i,t){let e=n.cloneNode(!1);n.tagName==="OL"&&t!==void 0&&t>1&&(e.start=t);for(let o of i)e.appendChild(o.cloneNode(!0));return e}function Ce(n,i,t){var l;let e=Array.from(n.children).filter(r=>r.tagName==="LI");if(e.length===0)return null;let o=n.tagName==="OL"&&(l=n.start)!=null?l:1,s=0;for(let r=0;r<e.length&&i(j(n,e.slice(0,r+1),o));r++)s=r+1;if(s<=0){if(!t||e.length<2)return null;s=1}return s>=e.length?null:[j(n,e.slice(0,s),o),j(n,e.slice(s),o+s)]}function U(n,i){let t=n.cloneNode(!1),e=n.querySelector("caption");e&&t.appendChild(e.cloneNode(!0));let o=n.querySelector("colgroup");o&&t.appendChild(o.cloneNode(!0)),n.tHead&&t.appendChild(n.tHead.cloneNode(!0));let s=document.createElement("tbody");for(let l of i)s.appendChild(l.cloneNode(!0));return t.appendChild(s),t}function Ee(n,i,t){let e=n.tBodies[0],o=e?Array.from(e.rows):Array.from(n.rows).filter(l=>{var r;return((r=l.parentElement)==null?void 0:r.tagName)!=="THEAD"});if(o.length===0)return null;let s=0;for(let l=0;l<o.length&&i(U(n,o.slice(0,l+1)));l++)s=l+1;if(s<=0){if(!t||o.length<2)return null;s=1}return s>=o.length?null:[U(n,o.slice(0,s)),U(n,o.slice(s))]}function G(n,i){let t=n.cloneNode(!1),e=n.querySelector("code");if(e){let o=e.cloneNode(!1);o.textContent=i.join(`
`),t.appendChild(o)}else t.textContent=i.join(`
`);return t}function He(n,i,t){var s;let e=((s=n.textContent)!=null?s:"").split(`
`);if(e.length>1&&e[e.length-1]===""&&e.pop(),e.length<2)return null;let o=0;for(let l=0;l<e.length&&i(G(n,e.slice(0,l+1)));l++)o=l+1;if(o<=0){if(!t||e.length<2)return null;o=1}return o>=e.length?null:[G(n,e.slice(0,o)),G(n,e.slice(o))]}function ve(n){if(!ge.has(n.tagName))return!1;for(let i of Array.from(n.childNodes))if(i.nodeType===Node.ELEMENT_NODE&&he.has(i.tagName))return!1;return!0}function Le(n,i,t){return fe.has(n.tagName)?null:n.tagName==="PRE"?He(n,i,t):n.tagName==="TABLE"?Ee(n,i,t):n.tagName==="UL"||n.tagName==="OL"?Ce(n,i,t):ve(n)?Te(n,i,t):null}function Se(n,i,t,e){var c;let o=document.createElement("div");o.style.cssText=["position:fixed","top:0","left:-99999px",`width:${i}px`,"visibility:hidden","pointer-events:none","z-index:-1"].join(";");let s=document.createElement("style");s.textContent=e,o.appendChild(s);let l=document.createElement("div");l.className="mpdf-doc",l.innerHTML=n,o.appendChild(l);let r=document.createElement("div");r.className="mpdf-doc",r.style.cssText=`position:absolute;top:0;left:0;width:${i}px;visibility:hidden;`,o.appendChild(r),document.body.appendChild(o);let a=[];try{let p=[],h=Array.from(l.children),f=0;for(;f<h.length;){let b=h[f],m=we(p,r,t);if(m(b.cloneNode(!0))){p.push(b.cloneNode(!0)),f++;continue}let T=p.length===0,y=Le(b,m,T);if(y){p.push(y[0]),a.push(p),p=[];let E=y[1];(c=E.textContent)!=null&&c.trim()||E.children.length>0?h[f]=E:f++;continue}if(p.length>0){a.push(p),p=[];continue}p.push(b.cloneNode(!0)),a.push(p),p=[],f++}p.length>0&&a.push(p)}finally{document.body.removeChild(o)}return a.length>0?a:[[]]}function ke(n,i){let t=n.length;return n.map((e,o)=>{var y,E,v;let s=o+1,l=i.showHeaderFooterOnFirstPage||o>0,r=i.showHeaderFooterOnFirstPage?i.pageNumberStart+o:i.pageNumberStart+(o-1),a=i.showHeaderFooterOnFirstPage?i.pageNumberStart+t-1:i.pageNumberStart+t-2,c=`${r} / ${a}`,p="",h="",f="",b="",m="",T="";return l&&(i.showPageNumbers?i.pageNumberPosition==="center"?f=(i.footerText?i.footerText+" \u2014 ":"")+c:i.pageNumberPosition==="left"?(p=c,h=(y=i.footerText)!=null?y:""):(p=(E=i.footerText)!=null?E:"",h=c):p=(v=i.footerText)!=null?v:"",i.headerText&&(i.headerAlignment==="center"?m=i.headerText:i.headerAlignment==="left"?b=i.headerText:T=i.headerText)),{pageNodes:e,pageNum:s,totalPages:t,headerLeft:b,headerCenter:m,headerRight:T,footerLeft:p,footerRight:h,footerCenter:f}})}var V=class extends d.Plugin{constructor(){super(...arguments);this.activeModal=null}async onload(){await this.loadSettings(),this.addCommand({id:"open-advanced-pdf-export",name:"Open Panel",callback:()=>this.openModal()}),this.registerEvent(this.app.workspace.on("file-menu",(t,e)=>{!(e instanceof d.TFile)||e.extension!=="md"||t.addItem(o=>o.setTitle("Advanced PDF Export: Open Panel").setIcon("file-output").onClick(()=>this.openModal(e)))})),this.addSettingTab(new K(this.app,this))}onunload(){var t;(t=this.activeModal)==null||t.close()}openModal(t){this.activeModal&&this.activeModal.close(),new R(this.app,this,t).open()}async loadSettings(){this.settings=Object.assign({},te,await this.loadData())}async saveSettings(){await this.saveData(this.settings)}async saveSettingsAndRender(){var t;await this.saveSettings(),(t=this.activeModal)==null||t.render()}applyPreset(t){let e=_[t];e&&(this.settings.preset=t,Object.assign(this.settings,e))}};function Be(n,i){var s,l;if(i)return i;let t=(s=n.workspace.getActiveViewOfType(d.MarkdownView))==null?void 0:s.file;if(t)return t;let e=n.workspace.getActiveFile();if((e==null?void 0:e.extension)==="md")return e;let o=n.workspace.getMostRecentLeaf();return(o==null?void 0:o.view)instanceof d.MarkdownView&&(l=o.view.file)!=null?l:null}var R=class extends d.Modal{constructor(t,e,o){super(t);this.renderComponent=new d.Component;this.currentFile=null;this.renderToken=0;this.layoutCache=null;this.renderDebounceTimer=null;this.plugin=e,this.initialFile=o!=null?o:null}async onOpen(){this.plugin.activeModal=this,this.renderComponent.load(),this.modalEl.addClass("mpdf-modal"),this.buildUI(this.contentEl);let t=Be(this.app,this.initialFile);if(t){this.currentFile=t;let e=await this.app.vault.read(t);this.editorEl.value=e,this.noteTitleEl.textContent=t.basename,this.noteTitleEl.title=t.path,this.showLoading(),await new Promise(o=>requestAnimationFrame(()=>requestAnimationFrame(()=>o()))),this.render(!0)}}onClose(){this.renderDebounceTimer!==null&&(clearTimeout(this.renderDebounceTimer),this.renderDebounceTimer=null),this.renderComponent.unload(),this.plugin.activeModal=null,this.currentFile=null,this.layoutCache=null}buildUI(t){let e=this.plugin.settings;this.buildTopbar(t.createEl("div",{cls:"mpdf-topbar"}),e);let o=t.createEl("div",{cls:"mpdf-main"}),s=o.createEl("div",{cls:"mpdf-editor-panel"});this.editorEl=s.createEl("textarea",{cls:"mpdf-editor"}),this.editorEl.placeholder=`Type or paste markdown here to preview and export as PDF.
...
| Col A | Col B |
|-------|-------|
| Cell  | Cell  |`;let l=o.createEl("div",{cls:"mpdf-preview-container"});this.previewEl=l.createEl("div",{cls:"mpdf-preview"}),this.loadingOverlayEl=l.createEl("div",{cls:"mpdf-loading-overlay"}),this.loadingOverlayEl.style.display="none",this.loadingOverlayEl.createEl("div",{cls:"mpdf-spinner"}),this.loadingOverlayEl.createEl("span",{cls:"mpdf-loading-text",text:"Rendering\u2026"}),this.editorEl.addEventListener("keydown",r=>{r.key==="Enter"&&(r.ctrlKey||r.metaKey)&&(r.preventDefault(),this.render(!0))})}buildTopbar(t,e){let o=t.createEl("div",{cls:"mpdf-topbar-left"});this.noteTitleEl=t.createEl("div",{cls:"mpdf-topbar-title",text:"\u2014"});let s=t.createEl("div",{cls:"mpdf-topbar-right"}),l=(m,T,y,E)=>{let v=o.createEl("div",{cls:"mpdf-ctrl"});v.createEl("span",{cls:"mpdf-ctrl-label",text:m});let M=v.createEl("select",{cls:"mpdf-select"});for(let[u,k]of Object.entries(T)){let L=M.createEl("option",{text:k,value:u});u===y&&(L.selected=!0)}M.addEventListener("change",()=>void E(M.value))},r={};Object.entries(_).forEach(([m,T])=>r[m]=T.name),l("Style",r,e.preset,async m=>{this.plugin.applyPreset(m),await this.plugin.saveSettingsAndRender()});let a={};Object.keys(q).forEach(m=>a[m]=m),l("Size",a,e.pageSize,async m=>{this.plugin.settings.pageSize=m,await this.plugin.saveSettingsAndRender()}),l("Orient",{portrait:"Portrait",landscape:"Landscape"},e.orientation,async m=>{this.plugin.settings.orientation=m,await this.plugin.saveSettingsAndRender()});let c=o.createEl("div",{cls:"mpdf-ctrl"});c.createEl("span",{cls:"mpdf-ctrl-label",text:"Zoom"});let p=c.createEl("span",{cls:"mpdf-ctrl-label",text:Math.round(e.previewScale*100)+"%"}),h=c.createEl("input");h.type="range",h.min="0.35",h.max="1.0",h.step="0.05",h.value=String(e.previewScale),h.addClass("mpdf-zoom-slider"),h.addEventListener("input",async()=>{let m=parseFloat(h.value);this.plugin.settings.previewScale=m,p.textContent=Math.round(m*100)+"%",await this.plugin.saveSettings(),this.renderPreviewOnly()});let f=o.createEl("button",{cls:"mpdf-btn",text:"Insert Page Break"});f.title="Insert page break (///)",f.addEventListener("click",()=>this.insertAtCursor(`
///
...
`)}async doRender(t){var $,g,C;let e=this.plugin.settings,o=ae(this.editorEl.value);e.hideFrontmatter&&(o=ie(o)),e.includeFilenameAsTitle&&this.currentFile&&(o=`# ${this.currentFile.basename}

${o}`),o=R.insertAutoBreaks(o,e.autoBreakH1,e.autoBreakH2);let s=le(o),l=($=q[e.pageSize])!=null?$:q.A4,r=e.orientation==="landscape"?l.h:l.w,a=e.orientation==="landscape"?l.w:l.h,c=z(e.marginTop),p=z(e.marginBottom),h=z(e.marginLeft),f=z(e.marginRight),b=e.showFooter?28:0,m=e.showHeader&&e.headerText?20:0,T=r-h-f,y=a-c-p-b-m,E=re(this.editorEl.value),v=me(e,E),M=(C=(g=this.currentFile)==null?void 0:g.path)!=null?C:"pdf-export",u=await Promise.all(s.map(F=>se(this.app,F.trim(),M,this.renderComponent)));if(t!==this.renderToken)return;let k=[];for(let F of u)k.push(...Se(F,T,y,v));let L=ke(k,e),B=e.fontFamily==="__custom__"?e.customFontName.trim()||"inherit":e.fontFamily;this.layoutCache={layouts:L,pw:r,ph:a,mTop:c,mLeft:h,footerH:b,headerH:m,contentW:T,contentH:y,docCSS:v,fontFamily:B,accentColor:e.accentColor,pageBackground:e.pageBackground,isRTL:E},this.drawPreview(this.layoutCache,e.previewScale),this.pageCountEl.textContent=`${L.length} page${L.length!==1?"s":""}`,this.hideLoading()}renderPreviewOnly(){this.layoutCache&&this.drawPreview(this.layoutCache,this.plugin.settings.previewScale)}showLoading(){this.loadingOverlayEl.style.display="flex",this.renderBtn.disabled=!0,this.renderBtn.textContent="Rendering\u2026"}hideLoading(){this.loadingOverlayEl.style.display="none",this.renderBtn.disabled=!1,this.renderBtn.textContent="\u27F3 Render PDF"}drawPreview(t,e){let{layouts:o,pw:s,ph:l,mTop:r,mLeft:a,footerH:c,headerH:p,contentW:h,docCSS:f,fontFamily:b,accentColor:m,pageBackground:T,isRTL:y}=t,E=this.plugin.settings;this.previewEl.empty();let v=new Map;o.forEach((u,k)=>{for(let L of u.pageNodes)L.querySelectorAll("[id]").forEach(B=>{v.has(B.id)||v.set(B.id,k)}),L.id&&!v.has(L.id)&&v.set(L.id,k)});let M=[];for(let u of o){let k=Math.round(s*e),L=Math.round(l*e),B=this.previewEl.createEl("div",{cls:"mpdf-page-wrap"});B.style.cssText=`width:${k}px;height:${L}px;position:relative;flex-shrink:0;`,B.createEl("div",{cls:"mpdf-page-label",text:`Page ${u.pageNum} of ${u.totalPages}`}),M.push(B);let $=B.createEl("div",{cls:"mpdf-page-scale"});$.style.cssText=`width:${k}px;height:${L}px;overflow:hidden;position:relative;`;let g=document.createElement("div");g.style.cssText=[`width:${s}px`,`height:${l}px`,`transform:scale(${e})`,"transform-origin:top left","position:absolute","top:0","left:0"].join(";"),$.appendChild(g);let C=g.attachShadow({mode:"open"}),F=document.createElement("style");if(F.textContent=`
        :host {
          display: block;
          width: ${s}px;
          height: ${l}px;
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ${f}
      `,C.appendChild(F),E.showHeader&&(u.headerLeft||u.headerCenter||u.headerRight)){let w=document.createElement("div");if(w.style.cssText=["position:absolute",`top:${r*.4}px`,`left:${a}px`,`right:${a}px`,"display:flex","align-items:center","font-size:9px","color:#999",`font-family:${b}`,"white-space:nowrap"].join(";"),u.headerCenter){let x=document.createElement("span");x.style.cssText="flex:1;text-align:center;",x.textContent=u.headerCenter,w.appendChild(x)}else{let x=document.createElement("span");x.textContent=u.headerLeft,w.appendChild(x);let H=document.createElement("span");H.style.marginLeft="auto",H.textContent=u.headerRight,w.appendChild(H)}C.appendChild(w)}let S=document.createElement("div");S.className="mpdf-doc",y&&S.setAttribute("dir","rtl"),S.style.cssText=["position:absolute",`top:${r+p}px`,`left:${a}px`,`width:${h}px`].join(";");for(let w of u.pageNodes)S.appendChild(w.cloneNode(!0));if(C.appendChild(S),S.querySelectorAll("a[href^='#']").forEach(w=>{let x=decodeURIComponent(w.getAttribute("href").slice(1)),H=v.get(x);H!==void 0&&(w.title=`Go to page ${H+1}`,w.addEventListener("click",A=>{var O;A.preventDefault(),(O=M[H])==null||O.scrollIntoView({behavior:"smooth",block:"start"})}))}),E.showFooter&&(u.footerLeft||u.footerRight||u.footerCenter)){let w=document.createElement("div");if(w.style.cssText=["position:absolute","bottom:0","left:0","right:0",`height:${c}px`,"display:flex","align-items:center",E.showFooterBorder?`border-top:0.5px solid ${m}33`:"",`padding:0 ${a}px`,"font-size:9px","color:#aaa",`font-family:${b}`].filter(Boolean).join(";"),u.footerCenter){let x=document.createElement("span");x.style.cssText="flex:1;text-align:center;",x.textContent=u.footerCenter,w.appendChild(x)}else{let x=document.createElement("span");x.textContent=u.footerLeft,w.appendChild(x);let H=document.createElement("span");H.style.marginLeft="auto",H.textContent=u.footerRight,w.appendChild(H)}C.appendChild(w)}}}async exportPDF(){var k,L,B,$;let t=this.plugin.settings;this.exportBtn.disabled=!0,this.exportBtn.textContent="\u2B07 Exporting\u2026";let e=()=>{this.exportBtn.disabled=!1,this.exportBtn.textContent="\u2B07 Export PDF"};if(!this.layoutCache){this.renderDebounceTimer!==null&&(clearTimeout(this.renderDebounceTimer),this.renderDebounceTimer=null);let g=++this.renderToken;this.showLoading();try{await this.doRender(g)}catch(C){let F=C instanceof Error?C.message:String(C);new d.Notice("Render error: "+F),this.hideLoading(),e();return}}let o=this.layoutCache;if(!o||o.layouts.length===0){new d.Notice("Nothing to export."),e();return}let{layouts:s,pw:l,ph:r,mTop:a,mLeft:c,footerH:p,headerH:h,contentW:f,docCSS:b,fontFamily:m,accentColor:T,pageBackground:y,isRTL:E}=o,v=s.map(g=>{let C=g.pageNodes.map(O=>O.outerHTML).join(`
`),F=t.showHeader&&(g.headerLeft||g.headerCenter||g.headerRight),P=g.headerCenter?`<span style="flex:1;text-align:center;">${D(g.headerCenter)}</span>`:`<span>${D(g.headerLeft)}</span><span style="margin-left:auto;">${D(g.headerRight)}</span>`,S=F?`<div style="position:absolute;top:${a*.4}px;left:${c}px;right:${c}px;display:flex;align-items:center;font-size:9px;color:#999;font-family:${m};white-space:nowrap;">${P}</div>`:"",N=g.footerCenter?`<span style="flex:1;text-align:center;">${D(g.footerCenter)}</span>`:`<span>${D(g.footerLeft)}</span><span style="margin-left:auto;">${D(g.footerRight)}</span>`,w=t.showFooter&&(g.footerLeft||g.footerRight||g.footerCenter),x=t.showFooterBorder?`border-top:0.5px solid ${T}33;`:"",H=w?`<div style="position:absolute;bottom:0;left:0;right:0;height:${p}px;display:flex;align-items:center;${x}padding:0 ${c}px;font-size:9px;color:#aaa;font-family:${m};">${N}</div>`:"",A=`<div class="mpdf-doc"${E?' dir="rtl"':""} style="position:absolute;top:${a+h}px;left:${c}px;width:${f}px;">${C}</div>`;return`<div class="mpdf-export-page">${S}${A}${H}</div>`}),M=`
...
<head>
<meta charset="UTF-8">
<title>${D((L=(k=this.currentFile)==null?void 0:k.basename)!=null?L:"Export")}</title>
<style>${M}</style>
</head>
<body>
${v.join(`
