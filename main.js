...
`)}function ie(t){return t.replace(/^---[ \t]*\r?\n[\s\S]*?\r?\n---[ \t]*(\r?\n|$)/,"")}function le(t){return t.split(/^\/\/\/\s*$/m).map(n=>n.trim()).filter(Boolean)}async function se(t,n,e,r){let i=activeDocument.createElement("div");return await s.MarkdownRenderer.render(t,n,i,e,r),ce(i),i}function de(t){return t.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function ce(t){let n=new Map;t.querySelectorAll("h1,h2,h3,h4,h5,h6").forEach(e=>{let r=e.textContent||"",i=de(r);if(!i)return;let l=n.get(i)??0;n.set(i,l+1),e.id=l===0?i:`${i}-${l}`}),t.querySelectorAll("a").forEach(e=>{e.classList.remove("external-link")}),t.querySelectorAll(".copy-code-button").forEach(e=>e.remove()),t.querySelectorAll(".callout").forEach(e=>{e.removeAttribute("data-callout-fold"),e.classList.remove("is-collapsed"),e.querySelectorAll(".callout-fold").forEach(r=>r.remove())}),t.querySelectorAll("style, script").forEach(e=>e.remove())}function pe(t){let n=t.replace(/^#([\da-f])([\da-f])([\da-f])$/i,(o,a,d,c)=>`#${a}${a}${d}${d}${c}${c}`);if(!/^#[\da-f]{6}$/i.test(n))return 1;let e=o=>o<=.04045?o/12.92:((o+.055)/1.055)**2.4,r=e(parseInt(n.slice(1,3),16)/255),i=e(parseInt(n.slice(3,5),16)/255),l=e(parseInt(n.slice(5,7),16)/255);return .2126*r+.7152*i+.0722*l}function me(t,n=!1){let e=t.headingScale,r=t.fontFamily==="__custom__"?t.customFontName.trim()||"inherit":t.fontFamily,i=pe(t.tableHeaderBg)<.35?"#fff":t.headingColor;return`
  ...
  `.trim()}function ge(t){return{name:t.name,fontFamily:t.fontFamily,fontSize:t.fontSize,lineHeight:t.lineHeight,paragraphSpacing:t.paragraphSpacing,headingScale:t.headingScale,accentColor:t.accentColor,bodyColor:t.bodyColor,headingColor:t.headingColor,h1BorderBottom:t.h1BorderBottom,h2BorderBottom:t.h2BorderBottom,centerH1:t.centerH1,blockquoteBg:t.blockquoteBg,blockquoteBorderColor:t.blockquoteBorderColor,codeBackground:t.codeBackground,codeFontSize:t.codeFontSize,tableHeaderBg:t.tableHeaderBg,tableStriped:t.tableStriped,pageBackground:t.pageBackground,marginTop:t.marginTop,marginBottom:t.marginBottom,marginLeft:t.marginLeft,marginRight:t.marginRight}}function he(){return Array.from(activeDocument.head.querySelectorAll("style[id^='MJX-']")).map(t=>t.textContent??"").join(`
`)}var fe=new Set(["P","LI","BLOCKQUOTE","TD","TH"]),ue=new Set(["P","DIV","SECTION","ARTICLE","ASIDE","NAV","HEADER","FOOTER","UL","OL","LI","TABLE","THEAD","TBODY","TFOOT","TR","TD","TH","PRE","BLOCKQUOTE","HR","IMG","H1","H2","H3","H4","H5","H6"]),be=new Set(["CODE","IMG","HR","H1","H2","H3","H4","H5","H6"]),we=2;function Te(t,n){n.empty();for(let e of t)n.appendChild(e.cloneNode(!0));return n.getBoundingClientRect().height}function xe(t,n,e){return r=>Te([...t,r],n)<=e-we}function Ce(t){let n=activeDocument.createTreeWalker(t,NodeFilter.SHOW_TEXT);for(;n.nextNode();){let e=n.currentNode,r=(e.textContent??"").replace(/^\s+/,"");if(r!==e.textContent&&(e.textContent=r),r.length>0)break}}function R(t,n){let e=activeDocument.createTreeWalker(t,NodeFilter.SHOW_TEXT),r=0,i=null,l=0;for(;e.nextNode();){let p=e.currentNode,f=p.textContent?.length??0;if(r+f>=n){i=p,l=n-r;break}r+=f}if(!i)return null;let o=activeDocument.createRange();o.selectNodeContents(t),o.setEnd(i,l);let a=activeDocument.createRange();a.selectNodeContents(t),a.setStart(i,l);let d=t.cloneNode(!1);d.appendChild(o.cloneContents());let c=t.cloneNode(!1);return c.appendChild(a.cloneContents()),Ce(c),[d,c]}function ve(t){let n=[],e=/\s+/g,r;for(;r=e.exec(t);)r.index>0&&r.index<t.length&&n.push(r.index);return n}function Se(t,n,e){let r=t.textContent??"";if(r.length<2)return null;let i=ve(r);if(i.length>0){let d=0,c=i.length-1,p=-1;for(;d<=c;){let f=Math.floor((d+c)/2),u=R(t,i[f]);if(!u){c=f-1;continue}n(u[0])?(p=f,d=f+1):c=f-1}if(p>=0)return R(t,i[p]);if(!e)return null}let l=1,o=r.length-1,a=0;for(;l<=o;){let d=Math.floor((l+o)/2),c=R(t,d);if(!c){o=d-1;continue}n(c[0])?(a=d,l=d+1):o=d-1}return a>0?R(t,a):null}function V(t,n,e){let r=t.cloneNode(!1);t.tagName==="OL"&&e!==void 0&&e>1&&(r.start=e);for(let i of n)r.appendChild(i.cloneNode(!0));return r}function ye(t,n,e){let r=Array.from(t.children).filter(o=>o.tagName==="LI");if(r.length===0)return null;let i=t.tagName==="OL"?t.start??1:1,l=0;for(let o=0;o<r.length&&n(V(t,r.slice(0,o+1),i));o++)l=o+1;if(l<=0){if(!e||r.length<2)return null;l=1}return l>=r.length?null:[V(t,r.slice(0,l),i),V(t,r.slice(l),i+l)]}function _(t,n){let e=t.cloneNode(!1),r=t.querySelector("caption");r&&e.appendChild(r.cloneNode(!0));let i=t.querySelector("colgroup");i&&e.appendChild(i.cloneNode(!0)),t.tHead&&e.appendChild(t.tHead.cloneNode(!0));let l=activeDocument.createElement("tbody");for(let o of n)l.appendChild(o.cloneNode(!0));return e.appendChild(l),e}function Ee(t,n,e){let r=t.tBodies[0],i=r?Array.from(r.rows):Array.from(t.rows).filter(o=>o.parentElement?.tagName!=="THEAD");if(i.length===0)return null;let l=0;for(let o=0;o<i.length&&n(_(t,i.slice(0,o+1)));o++)l=o+1;if(l<=0){if(!e||i.length<2)return null;l=1}return l>=i.length?null:[_(t,i.slice(0,l)),_(t,i.slice(l))]}function W(t,n){let e=t.cloneNode(!1),r=t.querySelector("code");if(r){let i=r.cloneNode(!1);i.textContent=n.join(`
`),e.appendChild(i)}else e.textContent=n.join(`
`);return e}function He(t,n,e){let r=(t.textContent??"").split(`
`);if(r.length>1&&r[r.length-1]===""&&r.pop(),r.length<2)return null;let i=0;for(let l=0;l<r.length&&n(W(t,r.slice(0,l+1)));l++)i=l+1;if(i<=0){if(!e||r.length<2)return null;i=1}return i>=r.length?null:[W(t,r.slice(0,i)),W(t,r.slice(i))]}function Be(t){if(!fe.has(t.tagName))return!1;for(let n of Array.from(t.childNodes))if(n.nodeType===Node.ELEMENT_NODE&&ue.has(n.tagName))return!1;return!0}function Le(t,n,e){return be.has(t.tagName)?null:t.tagName==="PRE"?He(t,n,e):t.tagName==="TABLE"?Ee(t,n,e):t.tagName==="UL"||t.tagName==="OL"?ye(t,n,e):Be(t)?Se(t,n,e):null}function ke(t,n,e,r){let i=activeDocument.createElement("div");i.style.cssText=["position:fixed","top:0","left:-99999px",`width:${n}px`,"visibility:hidden","pointer-events:none","z-index:-1"].join(";");let l=i.attachShadow({mode:"open"}),o=new CSSStyleSheet;o.replaceSync(r),l.adoptedStyleSheets=[o];let a=activeDocument.createElement("div");a.className="mpdf-doc";for(let p of Array.from(t.children))a.appendChild(p.cloneNode(!0));l.appendChild(a);let d=activeDocument.createElement("div");d.className="mpdf-doc",d.style.cssText=`position:absolute;top:0;left:0;width:${n}px;visibility:hidden;`,l.appendChild(d),activeDocument.body.appendChild(i);let c=[];try{let p=[],f=Array.from(a.children),u=0;for(;u<f.length;){let m=f[u],v=xe(p,d,e);if(v(m.cloneNode(!0))){p.push(m.cloneNode(!0)),u++;continue}let y=p.length===0,E=Le(m,v,y);if(E){p.push(E[0]),c.push(p),p=[];let x=E[1];x.textContent?.trim()||x.children.length>0?f[u]=x:u++;continue}if(p.length>0){c.push(p),p=[];continue}p.push(m.cloneNode(!0)),c.push(p),p=[],u++}p.length>0&&c.push(p)}finally{activeDocument.body.removeChild(i)}return c.length>0?c:[[]]}function Fe(t,n){let e=t.length;return t.map((r,i)=>{let l=i+1,o=n.showHeaderFooterOnFirstPage||i>0,a=n.showHeaderFooterOnFirstPage?n.pageNumberStart+i:n.pageNumberStart+(i-1),d=n.showHeaderFooterOnFirstPage?n.pageNumberStart+e-1:n.pageNumberStart+e-2,c=`${a} / ${d}`,p="",f="",u="",m="",v="",y="";return o&&(n.showPageNumbers?n.pageNumberPosition==="center"?u=(n.footerText?n.footerText+" \u2014 ":"")+c:n.pageNumberPosition==="left"?(p=c,f=n.footerText??""):(p=n.footerText??"",f=c):p=n.footerText??"",n.headerText&&(n.headerAlignment==="center"?v=n.headerText:n.headerAlignment==="left"?m=n.headerText:y=n.headerText)),{pageNodes:r,pageNum:l,totalPages:e,headerLeft:m,headerCenter:v,headerRight:y,footerLeft:p,footerRight:f,footerCenter:u}})}var O=class extends s.Plugin{activeModal=null;presetSnapshots={};async onload(){await this.loadSettings(),this.addCommand({id:"open-panel",name:"Open Panel",callback:()=>this.openModal()}),this.registerEvent(this.app.workspace.on("file-menu",(n,e)=>{!(e instanceof s.TFile)||e.extension!=="md"||n.addItem(r=>r.setTitle("Advanced PDF Export: Open Panel").setIcon("file-output").onClick(()=>this.openModal(e)))})),this.addSettingTab(new U(this.app,this))}onunload(){this.activeModal?.close()}openModal(n){this.activeModal&&this.activeModal.close(),new j(this.app,this,n).open()}async loadSettings(){let n=await this.loadData()??{};this.settings=Object.assign({},ee,n),this.presetSnapshots=n.presetSnapshots??{}}async saveSettings(){await this.saveData({...this.settings,presetSnapshots:this.presetSnapshots})}async saveSettingsAndRender(){await this.saveSettings(),this.activeModal?.render()}applyPreset(n,e=!1){let r=q[n];r&&(e?delete this.presetSnapshots[n]:this.presetSnapshots[this.settings.preset]=ge(this.settings),this.settings.preset=n,Object.assign(this.settings,r,e?{}:this.presetSnapshots[n]??{}))}};function De(t,n){if(n)return n;let e=t.workspace.getActiveViewOfType(s.MarkdownView)?.file;if(e)return e;let r=t.workspace.getActiveFile();if(r?.extension==="md")return r;let i=t.workspace.getMostRecentLeaf();return i?.view instanceof s.MarkdownView?i.view.file??null:null}var j=class t extends s.Modal{plugin;editorEl;previewEl;pageCountEl;noteTitleEl;renderBtn;exportBtn;loadingOverlayEl;renderComponent=new s.Component;initialFile;currentFile=null;renderToken=0;layoutCache=null;renderDebounceTimer=null;constructor(n,e,r){super(n),this.plugin=e,this.initialFile=r??null}async onOpen(){this.plugin.activeModal=this,this.renderComponent.load(),this.modalEl.addClass("mpdf-modal"),this.buildUI(this.contentEl);let n=De(this.app,this.initialFile);if(n){this.currentFile=n;let e=await this.app.vault.read(n);this.editorEl.value=e,this.noteTitleEl.textContent=n.basename,this.noteTitleEl.title=n.path,this.showLoading(),await new Promise(r=>window.requestAnimationFrame(()=>window.requestAnimationFrame(()=>r()))),this.render(!0)}}onClose(){this.renderDebounceTimer!==null&&(window.clearTimeout(this.renderDebounceTimer),this.renderDebounceTimer=null),this.renderComponent.unload(),this.plugin.activeModal=null,this.currentFile=null,this.layoutCache=null}buildUI(n){let e=this.plugin.settings;this.buildTopbar(n.createEl("div",{cls:"mpdf-topbar"}),e);let r=n.createEl("div",{cls:"mpdf-main"}),i=r.createEl("div",{cls:"mpdf-editor-panel"});this.editorEl=i.createEl("textarea",{cls:"mpdf-editor"}),this.editorEl.placeholder=`Type or paste markdown here to preview and export as PDF.
...
`)}async doRender(n){let e=this.plugin.settings,r=ae(this.editorEl.value);e.hideFrontmatter&&(r=ie(r)),e.includeFilenameAsTitle&&this.currentFile&&(r=`# ${this.currentFile.basename}

${r}`),r=t.insertAutoBreaks(r,e.autoBreakH1,e.autoBreakH2);let i=le(r),l=z[e.pageSize]??z.A4,o=e.orientation==="landscape"?l.h:l.w,a=e.orientation==="landscape"?l.w:l.h,d=A(e.marginTop),c=A(e.marginBottom),p=A(e.marginLeft),f=A(e.marginRight),u=e.showFooter?28:0,m=e.showHeader&&e.headerText?20:0,v=o-p-f,y=a-d-c-u-m,E=re(this.editorEl.value),x=me(e,E),k=this.currentFile?.path??"pdf-export",h=await Promise.all(i.map(S=>se(this.app,S.trim(),k,this.renderComponent)));if(n!==this.renderToken)return;let g=he(),b=g?`${g}
${x}`:x,T=[];for(let S of h)T.push(...ke(S,v,y,b));let F=Fe(T,e),B=e.fontFamily==="__custom__"?e.customFontName.trim()||"inherit":e.fontFamily;this.layoutCache={layouts:F,pw:o,ph:a,mTop:d,mLeft:p,footerH:u,headerH:m,contentW:v,contentH:y,docCSS:b,fontFamily:B,accentColor:e.accentColor,pageBackground:e.pageBackground,isRTL:E},this.drawPreview(this.layoutCache,e.previewScale),this.pageCountEl.textContent=`${F.length} page${F.length!==1?"s":""}`,this.hideLoading()}renderPreviewOnly(){this.layoutCache&&this.drawPreview(this.layoutCache,this.plugin.settings.previewScale)}showLoading(){this.loadingOverlayEl.addClass("is-active"),this.renderBtn.disabled=!0,this.renderBtn.textContent="Rendering\u2026"}hideLoading(){this.loadingOverlayEl.removeClass("is-active"),this.renderBtn.disabled=!1,this.renderBtn.textContent="\u27F3 Render PDF"}drawPreview(n,e){let{layouts:r,pw:i,ph:l,mTop:o,mLeft:a,footerH:d,headerH:c,contentW:p,docCSS:f,fontFamily:u,accentColor:m,pageBackground:v,isRTL:y}=n,E=this.plugin.settings;this.previewEl.empty();let x=new Map;r.forEach((h,g)=>{for(let b of h.pageNodes)b.querySelectorAll("[id]").forEach(T=>{x.has(T.id)||x.set(T.id,g)}),b.id&&!x.has(b.id)&&x.set(b.id,g)});let k=[];for(let h of r){let g=Math.round(i*e),b=Math.round(l*e),T=this.previewEl.createEl("div",{cls:"mpdf-page-wrap"});T.style.cssText=`width:${g}px;height:${b}px;`,T.createEl("div",{cls:"mpdf-page-label",text:`Page ${h.pageNum} of ${h.totalPages}`}),k.push(T);let F=T.createEl("div",{cls:"mpdf-page-scale"});F.style.cssText=`width:${g}px;height:${b}px;`;let B=activeDocument.createElement("div");B.addClass("mpdf-shadow-host"),B.style.cssText=`width:${i}px;height:${l}px;transform:scale(${e});`,F.appendChild(B);let S=B.attachShadow({mode:"open"}),D=`
        :host {
          display: block;
          width: ${i}px;
          height: ${l}px;
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        ${f}
      `,N=new CSSStyleSheet;if(N.replaceSync(D),S.adoptedStyleSheets=[N],E.showHeader&&(h.headerLeft||h.headerCenter||h.headerRight)){let w=activeDocument.createElement("div");if(w.style.cssText=["position:absolute",`top:${o*.4}px`,`left:${a}px`,`right:${a}px`,"display:flex","align-items:center","font-size:9px","color:#999",`font-family:${u}`,"white-space:nowrap"].join(";"),h.headerCenter){let C=activeDocument.createElement("span");C.className="mpdf-hf-center",C.textContent=h.headerCenter,w.appendChild(C)}else{let C=activeDocument.createElement("span");C.textContent=h.headerLeft,w.appendChild(C);let L=activeDocument.createElement("span");L.className="mpdf-hf-right",L.textContent=h.headerRight,w.appendChild(L)}S.appendChild(w)}let H=activeDocument.createElement("div");H.className="mpdf-doc",y&&H.setAttribute("dir","rtl"),H.style.cssText=["position:absolute",`top:${o+c}px`,`left:${a}px`,`width:${p}px`].join(";");for(let w of h.pageNodes)H.appendChild(w.cloneNode(!0));if(S.appendChild(H),H.querySelectorAll("a[href^='#']").forEach(w=>{let C=decodeURIComponent(w.getAttribute("href").slice(1)),L=x.get(C);L!==void 0&&(w.title=`Go to page ${L+1}`,w.addEventListener("click",G=>{G.preventDefault(),k[L]?.scrollIntoView({behavior:"smooth",block:"start"})}))}),E.showFooter&&(h.footerLeft||h.footerRight||h.footerCenter)){let w=activeDocument.createElement("div");if(w.style.cssText=["position:absolute","bottom:0","left:0","right:0",`height:${d}px`,"display:flex","align-items:center",E.showFooterBorder?`border-top:0.5px solid ${m}33`:"",`padding:0 ${a}px`,"font-size:9px","color:#aaa",`font-family:${u}`].filter(Boolean).join(";"),h.footerCenter){let C=activeDocument.createElement("span");C.className="mpdf-hf-center",C.textContent=h.footerCenter,w.appendChild(C)}else{let C=activeDocument.createElement("span");C.textContent=h.footerLeft,w.appendChild(C);let L=activeDocument.createElement("span");L.className="mpdf-hf-right",L.textContent=h.footerRight,w.appendChild(L)}S.appendChild(w)}}}async exportPDF(){let n=this.plugin.settings;this.exportBtn.disabled=!0,this.exportBtn.textContent="\u2B07 Exporting\u2026";let e=()=>{this.exportBtn.disabled=!1,this.exportBtn.textContent="\u2B07 Export PDF"};if(!this.layoutCache){this.renderDebounceTimer!==null&&(window.clearTimeout(this.renderDebounceTimer),this.renderDebounceTimer=null);let g=++this.renderToken;this.showLoading();try{await this.doRender(g)}catch(b){let T=b instanceof Error?b.message:String(b);new s.Notice("Render error: "+T),this.hideLoading(),e();return}}let r=this.layoutCache;if(!r||r.layouts.length===0){new s.Notice("Nothing to export."),e();return}let{layouts:i,pw:l,ph:o,mTop:a,mLeft:d,footerH:c,headerH:p,contentW:f,docCSS:u,fontFamily:m,accentColor:v,pageBackground:y,isRTL:E}=r,x=i.map(g=>{let b=g.pageNodes.map(P=>{if(P.nodeName==="STYLE"||P.nodeName==="SCRIPT")return"";let w=P.cloneNode(!0);return w.querySelectorAll("style, script").forEach(C=>C.remove()),w.outerHTML}).join(`
`),T=n.showHeader&&(g.headerLeft||g.headerCenter||g.headerRight),F=g.headerCenter?`<span style="flex:1;text-align:center;">${$(g.headerCenter)}</span>`:`<span>${$(g.headerLeft)}</span><span style="margin-left:auto;">${$(g.headerRight)}</span>`,B=T?`<div style="position:absolute;top:${a*.4}px;left:${d}px;right:${d}px;display:flex;align-items:center;font-size:9px;color:#999;font-family:${m};white-space:nowrap;">${F}</div>`:"",S=g.footerCenter?`<span style="flex:1;text-align:center;">${$(g.footerCenter)}</span>`:`<span>${$(g.footerLeft)}</span><span style="margin-left:auto;">${$(g.footerRight)}</span>`,D=n.showFooter&&(g.footerLeft||g.footerRight||g.footerCenter),N=n.showFooterBorder?`border-top:0.5px solid ${v}33;`:"",M=D?`<div style="position:absolute;bottom:0;left:0;right:0;height:${c}px;display:flex;align-items:center;${N}padding:0 ${d}px;font-size:9px;color:#aaa;font-family:${m};">${S}</div>`:"",H=`<div class="mpdf-doc"${E?' dir="rtl"':""} style="position:absolute;top:${a+p}px;left:${d}px;width:${f}px;">${b}</div>`;return`<div class="mpdf-export-page">${B}${H}${M}</div>`}),k=`
