...
`)}function oe(n){return n.replace(/^---[ \t]*\r?\n[\s\S]*?\r?\n---[ \t]*(\r?\n|$)/,"")}function ae(n){return n.split(/^\/\/\/\s*$/m).map(i=>i.trim()).filter(Boolean)}async function re(n,i,t,e){let o=document.createElement("div");return await d.MarkdownRenderer.render(n,i,o,t,e),le(o),o.innerHTML}function ie(n){return n.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function le(n){let i=new Map;n.querySelectorAll("h1,h2,h3,h4,h5,h6").forEach(t=>{var a;let e=t.textContent||"",o=ie(e);if(!o)return;let s=(a=i.get(o))!=null?a:0;i.set(o,s+1);let l=s===0?o:`${o}-${s}`;t.id=l}),n.querySelectorAll("a").forEach(t=>{t.classList.remove("external-link")}),n.querySelectorAll(".copy-code-button").forEach(t=>t.remove()),n.querySelectorAll(".callout").forEach(t=>{t.removeAttribute("data-callout-fold"),t.classList.remove("is-collapsed"),t.querySelectorAll(".callout-fold").forEach(e=>e.remove())})}function se(n){let i=n.replace(/^#([\da-f])([\da-f])([\da-f])$/i,(l,a,r,c)=>`#${a}${a}${r}${r}${c}${c}`);if(!/^#[\da-f]{6}$/i.test(i))return 1;let t=l=>l<=.04045?l/12.92:((l+.055)/1.055)**2.4,e=t(parseInt(i.slice(1,3),16)/255),o=t(parseInt(i.slice(3,5),16)/255),s=t(parseInt(i.slice(5,7),16)/255);return .2126*e+.7152*o+.0722*s}function de(n){let i=n.headingScale,t=n.fontFamily==="__custom__"?n.customFontName.trim()||"inherit":n.fontFamily,e=se(n.tableHeaderBg)<.35?"#fff":n.headingColor;return`
  ...
  `.trim()}var ce=new Set(["P","LI","BLOCKQUOTE","TD","TH"]),pe=new Set(["P","DIV","SECTION","ARTICLE","ASIDE","NAV","HEADER","FOOTER","UL","OL","LI","TABLE","THEAD","TBODY","TFOOT","TR","TD","TH","PRE","BLOCKQUOTE","HR","IMG","H1","H2","H3","H4","H5","H6"]),me=new Set(["CODE","IMG","HR","H1","H2","H3","H4","H5","H6"]),ge=.5;function he(n,i){i.innerHTML="";for(let t of n)i.appendChild(t.cloneNode(!0));return i.getBoundingClientRect().height}function fe(n,i,t){return e=>he([...n,e],i)<=t-ge}function ue(n){var t;let i=document.createTreeWalker(n,NodeFilter.SHOW_TEXT);for(;i.nextNode();){let e=i.currentNode,o=((t=e.textContent)!=null?t:"").replace(/^\s+/,"");if(o!==e.textContent&&(e.textContent=o),o.length>0)break}}function O(n,i){var p,h;let t=document.createTreeWalker(n,NodeFilter.SHOW_TEXT),e=0,o=null,s=0;for(;t.nextNode();){let u=t.currentNode,b=(h=(p=u.textContent)==null?void 0:p.length)!=null?h:0;if(e+b>=i){o=u,s=i-e;break}e+=b}if(!o)return null;let l=document.createRange();l.selectNodeContents(n),l.setEnd(o,s);let a=document.createRange();a.selectNodeContents(n),a.setStart(o,s);let r=n.cloneNode(!1);r.appendChild(l.cloneContents());let c=n.cloneNode(!1);return c.appendChild(a.cloneContents()),ue(c),[r,c]}function be(n){let i=[],t=/\s+/g,e;for(;e=t.exec(n);)e.index>0&&e.index<n.length&&i.push(e.index);return i}function we(n,i,t){var r;let e=(r=n.textContent)!=null?r:"";if(e.length<2)return null;let o=be(e);if(o.length>0){let c=0,p=o.length-1,h=-1;for(;c<=p;){let u=Math.floor((c+p)/2),b=O(n,o[u]);if(!b){p=u-1;continue}i(b[0])?(h=u,c=u+1):p=u-1}if(h>=0)return O(n,o[h]);if(!t)return null}let s=1,l=e.length-1,a=0;for(;s<=l;){let c=Math.floor((s+l)/2),p=O(n,c);if(!p){l=c-1;continue}i(p[0])?(a=c,s=c+1):l=c-1}return a>0?O(n,a):null}function _(n,i,t){let e=n.cloneNode(!1);n.tagName==="OL"&&t!==void 0&&t>1&&(e.start=t);for(let o of i)e.appendChild(o.cloneNode(!0));return e}function xe(n,i,t){var l;let e=Array.from(n.children).filter(a=>a.tagName==="LI");if(e.length===0)return null;let o=n.tagName==="OL"&&(l=n.start)!=null?l:1,s=0;for(let a=0;a<e.length&&i(_(n,e.slice(0,a+1),o));a++)s=a+1;if(s<=0){if(!t||e.length<2)return null;s=1}return s>=e.length?null:[_(n,e.slice(0,s),o),_(n,e.slice(s),o+s)]}function W(n,i){let t=n.cloneNode(!1),e=n.querySelector("caption");e&&t.appendChild(e.cloneNode(!0));let o=n.querySelector("colgroup");o&&t.appendChild(o.cloneNode(!0)),n.tHead&&t.appendChild(n.tHead.cloneNode(!0));let s=document.createElement("tbody");for(let l of i)s.appendChild(l.cloneNode(!0));return t.appendChild(s),t}function ye(n,i,t){let e=n.tBodies[0],o=e?Array.from(e.rows):Array.from(n.rows).filter(l=>{var a;return((a=l.parentElement)==null?void 0:a.tagName)!=="THEAD"});if(o.length===0)return null;let s=0;for(let l=0;l<o.length&&i(W(n,o.slice(0,l+1)));l++)s=l+1;if(s<=0){if(!t||o.length<2)return null;s=1}return s>=o.length?null:[W(n,o.slice(0,s)),W(n,o.slice(s))]}function j(n,i){let t=n.cloneNode(!1),e=n.querySelector("code");if(e){let o=e.cloneNode(!1);o.textContent=i.join(`
`),t.appendChild(o)}else t.textContent=i.join(`
`);return t}function Te(n,i,t){var s;let e=((s=n.textContent)!=null?s:"").split(`
`);if(e.length>1&&e[e.length-1]===""&&e.pop(),e.length<2)return null;let o=0;for(let l=0;l<e.length&&i(j(n,e.slice(0,l+1)));l++)o=l+1;if(o<=0){if(!t||e.length<2)return null;o=1}return o>=e.length?null:[j(n,e.slice(0,o)),j(n,e.slice(o))]}function Ce(n){if(!ce.has(n.tagName))return!1;for(let i of Array.from(n.childNodes))if(i.nodeType===Node.ELEMENT_NODE&&pe.has(i.tagName))return!1;return!0}function Ee(n,i,t){return me.has(n.tagName)?null:n.tagName==="PRE"?Te(n,i,t):n.tagName==="TABLE"?ye(n,i,t):n.tagName==="UL"||n.tagName==="OL"?xe(n,i,t):Ce(n)?we(n,i,t):null}function He(n,i,t,e){var c;let o=document.createElement("div");o.style.cssText=["position:fixed","top:0","left:-99999px",`width:${i}px`,"visibility:hidden","pointer-events:none","z-index:-1"].join(";");let s=document.createElement("style");s.textContent=e,o.appendChild(s);let l=document.createElement("div");l.className="mpdf-doc",l.innerHTML=n,o.appendChild(l);let a=document.createElement("div");a.className="mpdf-doc",a.style.cssText=`position:absolute;top:0;left:0;width:${i}px;visibility:hidden;`,o.appendChild(a),document.body.appendChild(o);let r=[];try{let p=[],h=Array.from(l.children),u=0;for(;u<h.length;){let b=h[u],m=fe(p,a,t);if(m(b.cloneNode(!0))){p.push(b.cloneNode(!0)),u++;continue}let T=p.length===0,y=Ee(b,m,T);if(y){p.push(y[0]),r.push(p),p=[];let E=y[1];(c=E.textContent)!=null&&c.trim()||E.children.length>0?h[u]=E:u++;continue}if(p.length>0){r.push(p),p=[];continue}p.push(b.cloneNode(!0)),r.push(p),p=[],u++}p.length>0&&r.push(p)}finally{document.body.removeChild(o)}return r.length>0?r:[[]]}function ve(n,i){let t=n.length;return n.map((e,o)=>{var T,y,E;let s=o+1,l=i.showHeaderFooterOnFirstPage||o>0,r=`${i.showHeaderFooterOnFirstPage?i.pageNumberStart+o:i.pageNumberStart+(o-1)} / ${t}`,c="",p="",h="",u="",b="",m="";return l&&(i.showPageNumbers?i.pageNumberPosition==="center"?h=(i.footerText?i.footerText+" \u2014 ":"")+r:i.pageNumberPosition==="left"?(c=r,p=(T=i.footerText)!=null?T:""):(c=(y=i.footerText)!=null?y:"",p=r):c=(E=i.footerText)!=null?E:"",i.headerText&&(i.headerAlignment==="center"?b=i.headerText:i.headerAlignment==="left"?u=i.headerText:m=i.headerText)),{pageNodes:e,pageNum:s,totalPages:t,headerLeft:u,headerCenter:b,headerRight:m,footerLeft:c,footerRight:p,footerCenter:h}})}var I=class extends d.Plugin{constructor(){super(...arguments);this.activeModal=null}async onload(){await this.loadSettings(),this.addCommand({id:"open-advanced-pdf-export",name:"Open Panel",callback:()=>this.openModal()}),this.registerEvent(this.app.workspace.on("file-menu",(t,e)=>{!(e instanceof d.TFile)||e.extension!=="md"||t.addItem(o=>o.setTitle("Advanced PDF Export: Open Panel").setIcon("file-output").onClick(()=>this.openModal(e)))})),this.addSettingTab(new U(this.app,this))}onunload(){var t;(t=this.activeModal)==null||t.close()}openModal(t){this.activeModal&&this.activeModal.close(),new A(this.app,this,t).open()}async loadSettings(){this.settings=Object.assign({},te,await this.loadData())}async saveSettings(){await this.saveData(this.settings)}async saveSettingsAndRender(){var t;await this.saveSettings(),(t=this.activeModal)==null||t.render()}applyPreset(t){let e=q[t];e&&(this.settings.preset=t,Object.assign(this.settings,e))}};function Se(n,i){var s,l;if(i)return i;let t=(s=n.workspace.getActiveViewOfType(d.MarkdownView))==null?void 0:s.file;if(t)return t;let e=n.workspace.getActiveFile();if((e==null?void 0:e.extension)==="md")return e;let o=n.workspace.getMostRecentLeaf();return(o==null?void 0:o.view)instanceof d.MarkdownView&&(l=o.view.file)!=null?l:null}var A=class extends d.Modal{constructor(t,e,o){super(t);this.renderComponent=new d.Component;this.currentFile=null;this.renderToken=0;this.layoutCache=null;this.renderDebounceTimer=null;this.plugin=e,this.initialFile=o!=null?o:null}async onOpen(){this.plugin.activeModal=this,this.renderComponent.load(),this.modalEl.addClass("mpdf-modal"),this.buildUI(this.contentEl);let t=Se(this.app,this.initialFile);if(t){this.currentFile=t;let e=await this.app.vault.read(t);this.editorEl.value=e,this.noteTitleEl.textContent=t.basename,this.noteTitleEl.title=t.path,this.showLoading(),await new Promise(o=>requestAnimationFrame(()=>requestAnimationFrame(()=>o()))),this.render(!0)}}onClose(){this.renderDebounceTimer!==null&&(clearTimeout(this.renderDebounceTimer),this.renderDebounceTimer=null),this.renderComponent.unload(),this.plugin.activeModal=null,this.currentFile=null,this.layoutCache=null}buildUI(t){let e=this.plugin.settings;this.buildTopbar(t.createEl("div",{cls:"mpdf-topbar"}),e);let o=t.createEl("div",{cls:"mpdf-main"}),s=o.createEl("div",{cls:"mpdf-editor-panel"});this.editorEl=s.createEl("textarea",{cls:"mpdf-editor"}),this.editorEl.placeholder=`Type or paste markdown here to preview and export as PDF.
...
`)}async doRender(t){var k,g,C;let e=this.plugin.settings,o=ne(this.editorEl.value);e.hideFrontmatter&&(o=oe(o)),e.includeFilenameAsTitle&&this.currentFile&&(o=`# ${this.currentFile.basename}

${o}`),o=A.insertAutoBreaks(o,e.autoBreakH1,e.autoBreakH2);let s=ae(o),l=(k=z[e.pageSize])!=null?k:z.A4,a=e.orientation==="landscape"?l.h:l.w,r=e.orientation==="landscape"?l.w:l.h,c=R(e.marginTop),p=R(e.marginBottom),h=R(e.marginLeft),u=R(e.marginRight),b=e.showFooter?28:0,m=e.showHeader&&e.headerText?20:0,T=a-h-u,y=r-c-p-b-m,E=de(e),B=(C=(g=this.currentFile)==null?void 0:g.path)!=null?C:"pdf-export",M=await Promise.all(s.map(L=>re(this.app,L.trim(),B,this.renderComponent)));if(t!==this.renderToken)return;let f=[];for(let L of M)f.push(...He(L,T,y,E));let v=ve(f,e),S=e.fontFamily==="__custom__"?e.customFontName.trim()||"inherit":e.fontFamily;this.layoutCache={layouts:v,pw:a,ph:r,mTop:c,mLeft:h,footerH:b,headerH:m,contentW:T,contentH:y,docCSS:E,fontFamily:S,accentColor:e.accentColor,pageBackground:e.pageBackground},this.drawPreview(this.layoutCache,e.previewScale),this.pageCountEl.textContent=`${v.length} page${v.length!==1?"s":""}`,this.hideLoading()}renderPreviewOnly(){this.layoutCache&&this.drawPreview(this.layoutCache,this.plugin.settings.previewScale)}showLoading(){this.loadingOverlayEl.style.display="flex",this.renderBtn.disabled=!0,this.renderBtn.textContent="Rendering\u2026"}hideLoading(){this.loadingOverlayEl.style.display="none",this.renderBtn.disabled=!1,this.renderBtn.textContent="\u27F3 Render PDF"}drawPreview(t,e){let{layouts:o,pw:s,ph:l,mTop:a,mLeft:r,footerH:c,headerH:p,contentW:h,contentH:u,docCSS:b,fontFamily:m,accentColor:T,pageBackground:y}=t,E=this.plugin.settings;this.previewEl.empty();let B=new Map;o.forEach((f,v)=>{for(let S of f.pageNodes)S.querySelectorAll("[id]").forEach(k=>{B.has(k.id)||B.set(k.id,v)}),S.id&&!B.has(S.id)&&B.set(S.id,v)});let M=[];for(let f of o){let v=Math.round(s*e),S=Math.round(l*e),k=this.previewEl.createEl("div",{cls:"mpdf-page-wrap"});k.style.cssText=`width:${v}px;height:${S}px;position:relative;flex-shrink:0;`,k.createEl("div",{cls:"mpdf-page-label",text:`Page ${f.pageNum} of ${f.totalPages}`}),M.push(k);let g=k.createEl("div",{cls:"mpdf-page-scale"});g.style.cssText=`width:${v}px;height:${S}px;overflow:hidden;position:relative;`;let C=document.createElement("div");C.style.cssText=[`width:${s}px`,`height:${l}px`,`transform:scale(${e})`,"transform-origin:top left","position:absolute","top:0","left:0"].join(";"),g.appendChild(C);let L=C.attachShadow({mode:"open"}),N=document.createElement("style");if(N.textContent=`
        :host {
          display: block;
          width: ${s}px;
          height: ${l}px;
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ${b}
      `,L.appendChild(N),E.showHeader&&(f.headerLeft||f.headerCenter||f.headerRight)){let w=document.createElement("div");if(w.style.cssText=["position:absolute",`top:${a*.4}px`,`left:${r}px`,`right:${r}px`,"display:flex","align-items:center","font-size:9px","color:#999",`font-family:${m}`,"white-space:nowrap"].join(";"),f.headerCenter){let x=document.createElement("span");x.style.cssText="flex:1;text-align:center;",x.textContent=f.headerCenter,w.appendChild(x)}else{let x=document.createElement("span");x.textContent=f.headerLeft,w.appendChild(x);let H=document.createElement("span");H.style.marginLeft="auto",H.textContent=f.headerRight,w.appendChild(H)}L.appendChild(w)}let F=document.createElement("div");F.className="mpdf-doc",F.style.cssText=["position:absolute",`top:${a+p}px`,`left:${r}px`,`width:${h}px`,`height:${u}px`,"overflow:hidden"].join(";");for(let w of f.pageNodes)F.appendChild(w.cloneNode(!0));if(L.appendChild(F),F.querySelectorAll("a[href^='#']").forEach(w=>{let x=decodeURIComponent(w.getAttribute("href").slice(1)),H=B.get(x);H!==void 0&&(w.title=`Go to page ${H+1}`,w.addEventListener("click",K=>{var G;K.preventDefault(),(G=M[H])==null||G.scrollIntoView({behavior:"smooth",block:"start"})}))}),E.showFooter&&(f.footerLeft||f.footerRight||f.footerCenter)){let w=document.createElement("div");if(w.style.cssText=["position:absolute","bottom:0","left:0","right:0",`height:${c}px`,"display:flex","align-items:center",`border-top:0.5px solid ${T}33`,`padding:0 ${r}px`,"font-size:9px","color:#aaa",`font-family:${m}`].join(";"),f.footerCenter){let x=document.createElement("span");x.style.cssText="flex:1;text-align:center;",x.textContent=f.footerCenter,w.appendChild(x)}else{let x=document.createElement("span");x.textContent=f.footerLeft,w.appendChild(x);let H=document.createElement("span");H.style.marginLeft="auto",H.textContent=f.footerRight,w.appendChild(H)}L.appendChild(w)}}}async exportPDF(){var f,v,S,k;let t=this.plugin.settings;this.exportBtn.disabled=!0,this.exportBtn.textContent="\u2B07 Exporting\u2026";let e=()=>{this.exportBtn.disabled=!1,this.exportBtn.textContent="\u2B07 Export PDF"};if(!this.layoutCache){this.renderDebounceTimer!==null&&(clearTimeout(this.renderDebounceTimer),this.renderDebounceTimer=null);let g=++this.renderToken;this.showLoading();try{await this.doRender(g)}catch(C){let L=C instanceof Error?C.message:String(C);new d.Notice("Render error: "+L),this.hideLoading(),e();return}}let o=this.layoutCache;if(!o||o.layouts.length===0){new d.Notice("Nothing to export."),e();return}let{layouts:s,pw:l,ph:a,mTop:r,mLeft:c,footerH:p,headerH:h,contentW:u,docCSS:b,fontFamily:m,accentColor:T,pageBackground:y}=o,E=s.map(g=>{let C=g.pageNodes.map(H=>H.outerHTML).join(`
`),L=t.showHeader&&(g.headerLeft||g.headerCenter||g.headerRight),N=g.headerCenter?`<span style="flex:1;text-align:center;">${P(g.headerCenter)}</span>`:`<span>${P(g.headerLeft)}</span><span style="margin-left:auto;">${P(g.headerRight)}</span>`,$=L?`<div style="position:absolute;top:${r*.4}px;left:${c}px;right:${c}px;display:flex;align-items:center;font-size:9px;color:#999;font-family:${m};white-space:nowrap;">${N}</div>`:"",F=g.footerCenter?`<span style="flex:1;text-align:center;">${P(g.footerCenter)}</span>`:`<span>${P(g.footerLeft)}</span><span style="margin-left:auto;">${P(g.footerRight)}</span>`,w=t.showFooter&&(g.footerLeft||g.footerRight||g.footerCenter)?`<div style="position:absolute;bottom:0;left:0;right:0;height:${p}px;display:flex;align-items:center;border-top:0.5px solid ${T}33;padding:0 ${c}px;font-size:9px;color:#aaa;font-family:${m};">${F}</div>`:"",x=`<div class="mpdf-doc" style="position:absolute;top:${r+h}px;left:${c}px;width:${u}px;">${C}</div>`;return`<div class="mpdf-export-page">${$}${x}${w}</div>`}),B=`
...
<head>
<meta charset="UTF-8">
<title>${P((v=(f=this.currentFile)==null?void 0:f.basename)!=null?v:"Export")}</title>
<style>${B}</style>
</head>
<body>
${E.join(`
