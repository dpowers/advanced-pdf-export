...
`)}function ge(t){return t.replace(/^---[ \t]*\n[\s\S]*?\n---[ \t]*(\n|$)/,"")}function he(t){return t.split(/^\/\/\/\s*$/m).map(o=>o.trim()).filter(Boolean)}async function ue(t,o,e,r){let i=activeDocument.createElement("div");i.setCssStyles({position:"fixed",top:"0",left:"-99999px",visibility:"hidden",pointerEvents:"none"}),activeDocument.body.appendChild(i);try{await d.MarkdownRenderer.render(t,o,i,e,r),await be(i)}finally{activeDocument.body.removeChild(i)}return fe(i),i}function X(t){return t.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function fe(t){let o=new Map;t.querySelectorAll("h1,h2,h3,h4,h5,h6").forEach(e=>{let r=e.textContent||"",i=X(r);if(!i)return;let s=o.get(i)??0;o.set(i,s+1),e.id=s===0?i:`${i}-${s}`}),t.querySelectorAll("a").forEach(e=>{e.classList.remove("external-link");let r=e.getAttribute("data-href")??e.getAttribute("href");r?.startsWith("#")&&e.setAttribute("href","#"+X(r.slice(1)))}),t.querySelectorAll(".copy-code-button").forEach(e=>e.remove()),t.querySelectorAll(".callout").forEach(e=>{e.removeAttribute("data-callout-fold"),e.classList.remove("is-collapsed"),e.querySelectorAll(".callout-fold").forEach(r=>r.remove())}),t.querySelectorAll("style, script").forEach(e=>{e.closest("svg")||e.remove()})}async function be(t){let o=Array.from(t.querySelectorAll(".mermaid"));if(o.length===0)return;let e=5e3;await Promise.all(o.map(r=>new Promise(i=>{if(r.querySelector("svg")){i();return}let s=window.setTimeout(()=>{l.disconnect(),i()},e),l=new MutationObserver(()=>{r.querySelector("svg")&&(window.clearTimeout(s),l.disconnect(),i())});l.observe(r,{childList:!0,subtree:!0})})))}var we={comment:["comment","prolog","doctype","cdata"],punctuation:["punctuation"],property:["property","tag","boolean","number","constant","symbol","deleted","attr-name"],selector:["selector","string","char","builtin","inserted","attr-value"],operator:["operator","entity","url"],keyword:["atrule","keyword","important"],function:["function","class-name"],regex:["regex","variable"]},G={none:{name:"None (plain)"},"github-light":{name:"GitHub Light",background:"#f6f8fa",text:"#24292e",tokens:{comment:"#6a737d",punctuation:"#24292e",property:"#005cc5",selector:"#032f62",operator:"#d73a49",keyword:"#d73a49",function:"#6f42c1",regex:"#032f62"}},"github-dark":{name:"GitHub Dark",background:"#0d1117",text:"#c9d1d9",tokens:{comment:"#8b949e",punctuation:"#c9d1d9",property:"#79c0ff",selector:"#a5d6ff",operator:"#ff7b72",keyword:"#ff7b72",function:"#d2a8ff",regex:"#a5d6ff"}},"atom-one-light":{name:"Atom One Light",background:"#fafafa",text:"#383a42",tokens:{comment:"#a0a1a7",punctuation:"#383a42",property:"#986801",selector:"#50a14f",operator:"#0184bc",keyword:"#a626a4",function:"#4078f2",regex:"#50a14f"}},"atom-one-dark":{name:"Atom One Dark",background:"#282c34",text:"#abb2bf",tokens:{comment:"#5c6370",punctuation:"#abb2bf",property:"#d19a66",selector:"#98c379",operator:"#56b6c2",keyword:"#c678dd",function:"#61afef",regex:"#98c379"}},monokai:{name:"Monokai",background:"#272822",text:"#f8f8f2",tokens:{comment:"#75715e",punctuation:"#f8f8f2",property:"#ae81ff",selector:"#e6db74",operator:"#f92672",keyword:"#f92672",function:"#a6e22e",regex:"#e6db74"}},dracula:{name:"Dracula",background:"#282a36",text:"#f8f8f2",tokens:{comment:"#6272a4",punctuation:"#f8f8f2",property:"#bd93f9",selector:"#f1fa8c",operator:"#ff79c6",keyword:"#ff79c6",function:"#50fa7b",regex:"#ff79c6"}},"tokyo-night":{name:"Tokyo Night",background:"#1a1b26",text:"#a9b1d6",tokens:{comment:"#565f89",punctuation:"#89ddff",property:"#ff9e64",selector:"#9ece6a",operator:"#89ddff",keyword:"#bb9af7",function:"#7aa2f7",regex:"#b4f9f8"}},"solarized-light":{name:"Solarized Light",background:"#fdf6e3",text:"#586e75",tokens:{comment:"#93a1a1",punctuation:"#586e75",property:"#cb4b16",selector:"#2aa198",operator:"#859900",keyword:"#859900",function:"#268bd2",regex:"#2aa198"}},"catppuccin-macchiato":{name:"Catppuccin Macchiato",background:"#24273a",text:"#cad3f5",tokens:{comment:"#939ab7",punctuation:"#b8c0e0",property:"#f5a97f",selector:"#a6da95",operator:"#91d7e3",keyword:"#c6a0f6",function:"#8aadf4",regex:"#f5bde6"}},"catppuccin-mocha":{name:"Catppuccin Mocha",background:"#1e1e2e",text:"#cdd6f4",tokens:{comment:"#9399b2",punctuation:"#bac2de",property:"#fab387",selector:"#a6e3a1",operator:"#89dceb",keyword:"#cba6f7",function:"#89b4fa",regex:"#f5c2e7"}}};function xe(t){let o=G[t.codeTheme]??G.none,e=o.background??t.codeBackground,r=o.text??t.bodyColor,i=Object.entries(o.tokens??{}).map(([s,l])=>`${we[s].map(c=>`.mpdf-doc pre code .token.${c}`).join(", ")} { color: ${l};${s==="comment"?" font-style: italic;":""} }`).join(`
  ...
  ${i}`}function Ce(t){let o=t.replace(/^#([\da-f])([\da-f])([\da-f])$/i,(l,a,n,c)=>`#${a}${a}${n}${n}${c}${c}`);if(!/^#[\da-f]{6}$/i.test(o))return 1;let e=l=>l<=.04045?l/12.92:((l+.055)/1.055)**2.4,r=e(parseInt(o.slice(1,3),16)/255),i=e(parseInt(o.slice(3,5),16)/255),s=e(parseInt(o.slice(5,7),16)/255);return .2126*r+.7152*i+.0722*s}function J(t){return t.fontFamily==="__custom__"?t.customFontName.trim()||"inherit":t.fontFamily}function ye(t,o=!1){let e=t.headingScale,r=J(t),i=Ce(t.tableHeaderBg)<.35?"#fff":t.headingColor;return`
  .mpdf-doc {
    font-family: ${r};
  ...
  `.trim()}function Se(t){return{name:t.name,fontFamily:t.fontFamily,fontSize:t.fontSize,lineHeight:t.lineHeight,paragraphSpacing:t.paragraphSpacing,headingScale:t.headingScale,accentColor:t.accentColor,bodyColor:t.bodyColor,headingColor:t.headingColor,h1BorderBottom:t.h1BorderBottom,h2BorderBottom:t.h2BorderBottom,centerH1:t.centerH1,blockquoteBg:t.blockquoteBg,blockquoteBorderColor:t.blockquoteBorderColor,codeBackground:t.codeBackground,codeFontSize:t.codeFontSize,codeTheme:t.codeTheme,tableHeaderBg:t.tableHeaderBg,tableStriped:t.tableStriped,pageBackground:t.pageBackground,marginTop:t.marginTop,marginBottom:t.marginBottom,marginLeft:t.marginLeft,marginRight:t.marginRight}}function Te(){return Array.from(activeDocument.head.querySelectorAll("style[id^='MJX-']")).map(t=>t.textContent??"").join(`
`)}var ve=new Set(["P","LI","BLOCKQUOTE","TD","TH"]),Ee=new Set(["P","DIV","SECTION","ARTICLE","ASIDE","NAV","HEADER","FOOTER","UL","OL","LI","TABLE","THEAD","TBODY","TFOOT","TR","TD","TH","PRE","BLOCKQUOTE","HR","IMG","H1","H2","H3","H4","H5","H6"]),He=new Set(["CODE","IMG","HR","H1","H2","H3","H4","H5","H6"]),ke=2;function Be(t,o){o.empty();for(let e of t)o.appendChild(e.cloneNode(!0));return o.getBoundingClientRect().height}function Le(t,o,e){return r=>Be([...t,r],o)<=e-ke}function Fe(t){let o=activeDocument.createTreeWalker(t,NodeFilter.SHOW_TEXT);for(;o.nextNode();){let e=o.currentNode,r=(e.textContent??"").replace(/^\s+/,"");if(r!==e.textContent&&(e.textContent=r),r.length>0)break}}function $(t,o,e=!0){let r=activeDocument.createTreeWalker(t,NodeFilter.SHOW_TEXT),i=0,s=null,l=0;for(;r.nextNode();){let h=r.currentNode,u=h.textContent?.length??0;if(i+u>=o){s=h,l=o-i;break}i+=u}if(!s)return null;let a=activeDocument.createRange();a.selectNodeContents(t),a.setEnd(s,l);let n=activeDocument.createRange();n.selectNodeContents(t),n.setStart(s,l);let c=t.cloneNode(!1);c.appendChild(a.cloneContents());let p=t.cloneNode(!1);return p.appendChild(n.cloneContents()),e&&Fe(p),[c,p]}function Me(t){let o=[],e=/\s+/g,r;for(;r=e.exec(t);)r.index>0&&r.index<t.length&&o.push(r.index);return o}function De(t,o,e){let r=t.textContent??"";if(r.length<2)return null;let i=Me(r);if(i.length>0){let n=0,c=i.length-1,p=-1;for(;n<=c;){let h=Math.floor((n+c)/2),u=$(t,i[h]);if(!u){c=h-1;continue}o(u[0])?(p=h,n=h+1):c=h-1}if(p>=0)return $(t,i[p]);if(!e)return null}let s=1,l=r.length-1,a=0;for(;s<=l;){let n=Math.floor((s+l)/2),c=$(t,n);if(!c){l=n-1;continue}o(c[0])?(a=n,s=n+1):l=n-1}return a>0?$(t,a):null}function W(t,o,e){let r=t.cloneNode(!1);t.tagName==="OL"&&e!==void 0&&e>1&&(r.start=e);for(let i of o)r.appendChild(i.cloneNode(!0));return r}function Ne(t,o,e){let r=Array.from(t.children).filter(l=>l.tagName==="LI");if(r.length===0)return null;let i=t.tagName==="OL"?t.start??1:1,s=0;for(let l=0;l<r.length&&o(W(t,r.slice(0,l+1),i));l++)s=l+1;if(s<=0){if(!e||r.length<2)return null;s=1}return s>=r.length?null:[W(t,r.slice(0,s),i),W(t,r.slice(s),i+s)]}function _(t,o){let e=t.cloneNode(!1),r=t.querySelector("caption");r&&e.appendChild(r.cloneNode(!0));let i=t.querySelector("colgroup");i&&e.appendChild(i.cloneNode(!0)),t.tHead&&e.appendChild(t.tHead.cloneNode(!0));let s=activeDocument.createElement("tbody");for(let l of o)s.appendChild(l.cloneNode(!0));return e.appendChild(s),e}function Pe(t,o,e){let r=t.tBodies[0],i=r?Array.from(r.rows):Array.from(t.rows).filter(l=>l.parentElement?.tagName!=="THEAD");if(i.length===0)return null;let s=0;for(let l=0;l<i.length&&o(_(t,i.slice(0,l+1)));l++)s=l+1;if(s<=0){if(!e||i.length<2)return null;s=1}return s>=i.length?null:[_(t,i.slice(0,s)),_(t,i.slice(s))]}function $e(t){let o=[],e=0;for(let r of t)e+=r.length+1,o.push(e);return o}function Ae(t,o,e){let r=t.querySelector("code"),i=(r??t).textContent?.split(`
`)??[];if(i.length>1&&i[i.length-1]===""&&i.pop(),i.length<2)return null;let s=$e(i),l=c=>{if(!r){let w=C=>{let y=t.cloneNode(!1);return y.textContent=C,y};return[w(i.slice(0,c).join(`
`)),w(i.slice(c).join(`
`))]}let p=$(r,s[c-1],!1);if(!p)return null;let h=t.cloneNode(!1);h.appendChild(p[0]);let u=t.cloneNode(!1);return u.appendChild(p[1]),[h,u]},a=null,n=0;for(let c=1;c<=i.length;c++){let p=l(c);if(!p||!o(p[0]))break;a=p,n=c}if(n<=0){if(!e)return null;a=l(1),n=1}return n>=i.length||!a?null:a}function Re(t){if(!ve.has(t.tagName))return!1;for(let o of Array.from(t.childNodes))if(o.nodeType===Node.ELEMENT_NODE&&Ee.has(o.tagName))return!1;return!0}function ze(t,o,e){return He.has(t.tagName)?null:t.tagName==="PRE"?Ae(t,o,e):t.tagName==="TABLE"?Pe(t,o,e):t.tagName==="UL"||t.tagName==="OL"?Ne(t,o,e):Re(t)?De(t,o,e):null}function Oe(t,o,e,r){let i=activeDocument.createElement("div");i.setCssStyles({position:"fixed",top:"0",left:"-99999px",width:`${o}px`,visibility:"hidden",pointerEvents:"none",zIndex:"-1"});let s=i.attachShadow({mode:"open"}),l=new CSSStyleSheet;l.replaceSync(r),s.adoptedStyleSheets=[l];let a=activeDocument.createElement("div");a.className="mpdf-doc";for(let p of Array.from(t.children))a.appendChild(p.cloneNode(!0));s.appendChild(a);let n=activeDocument.createElement("div");n.className="mpdf-doc",n.setCssStyles({position:"absolute",top:"0",left:"0",width:`${o}px`,visibility:"hidden"}),s.appendChild(n),activeDocument.body.appendChild(i);let c=[];try{let p=[],h=Array.from(a.children),u=0;for(;u<h.length;){let w=h[u],C=Le(p,n,e);if(C(w)){p.push(w.cloneNode(!0)),u++;continue}let y=p.length===0,E=ze(w,C,y);if(E){p.push(E[0]),c.push(p),p=[];let b=E[1];b.textContent?.trim()||b.children.length>0?h[u]=b:u++;continue}if(p.length>0){c.push(p),p=[];continue}p.push(w.cloneNode(!0)),c.push(p),p=[],u++}p.length>0&&c.push(p)}finally{activeDocument.body.removeChild(i)}return c.length>0?c:[[]]}function qe(t,o){let e=t.length;return t.map((r,i)=>{let s=i+1,l=o.showHeaderFooterOnFirstPage||i>0,a=o.showHeaderFooterOnFirstPage?o.pageNumberStart+i:o.pageNumberStart+(i-1),n=o.showHeaderFooterOnFirstPage?o.pageNumberStart+e-1:o.pageNumberStart+e-2,c=`${a} / ${n}`,p="",h="",u="",w="",C="",y="";return l&&(o.showPageNumbers?o.pageNumberPosition==="center"?u=(o.footerText?o.footerText+" \u2014 ":"")+c:o.pageNumberPosition==="left"?(p=c,h=o.footerText??""):(p=o.footerText??"",h=c):p=o.footerText??"",o.headerText&&(o.headerAlignment==="center"?C=o.headerText:o.headerAlignment==="left"?w=o.headerText:y=o.headerText)),{pageNodes:r,pageNum:s,totalPages:e,headerLeft:w,headerCenter:C,headerRight:y,footerLeft:p,footerRight:h,footerCenter:u}})}function Y(t,o,e,r){if(!(!o&&!e&&!r))if(o){let i=activeDocument.createElement("span");i.className="mpdf-hf-center",i.textContent=o,t.appendChild(i)}else{let i=activeDocument.createElement("span");i.textContent=e,t.appendChild(i);let s=activeDocument.createElement("span");s.className="mpdf-hf-right",s.textContent=r,t.appendChild(s)}}function Z(t,o,e){return!t&&!o&&!e?"":t?`<span style="flex:1;text-align:center;">${R(t)}</span>`:`<span>${R(o)}</span><span style="margin-left:auto;">${R(e)}</span>`}var O=class extends d.Plugin{activeModal=null;presetSnapshots={};async onload(){await this.loadSettings(),this.addCommand({id:"open-panel",name:"Open Panel",callback:()=>this.openModal()}),this.registerEvent(this.app.workspace.on("file-menu",(o,e)=>{!(e instanceof d.TFile)||e.extension!=="md"||o.addItem(r=>r.setTitle("Advanced PDF Export: Open Panel").setIcon("file-output").onClick(()=>this.openModal(e)))})),this.addSettingTab(new U(this.app,this))}onunload(){this.activeModal?.close()}openModal(o){this.activeModal&&this.activeModal.close(),new j(this.app,this,o).open()}async loadSettings(){let o=await this.loadData()??{};this.settings=Object.assign({},K,o),o.codeTheme===void 0&&(this.settings.codeTheme=A[this.settings.preset]?.codeTheme??K.codeTheme),this.presetSnapshots=o.presetSnapshots??{}}async saveSettings(){await this.saveData({...this.settings,presetSnapshots:this.presetSnapshots})}async saveSettingsAndRender(){await this.saveSettings(),this.activeModal?.render()}applyPreset(o,e=!1){let r=A[o];r&&(e?delete this.presetSnapshots[o]:this.presetSnapshots[this.settings.preset]=Se(this.settings),this.settings.preset=o,Object.assign(this.settings,r,e?{}:this.presetSnapshots[o]??{}))}};function Ie(t,o){if(o)return o;let e=t.workspace.getActiveViewOfType(d.MarkdownView)?.file;if(e)return e;let r=t.workspace.getActiveFile();if(r?.extension==="md")return r;let i=t.workspace.getMostRecentLeaf();return i?.view instanceof d.MarkdownView?i.view.file??null:null}var j=class t extends d.Modal{plugin;editorEl;previewEl;pageCountEl;noteTitleEl;renderBtn;exportBtn;loadingOverlayEl;renderComponent=new d.Component;initialFile;currentFile=null;renderToken=0;layoutCache=null;renderDebounceTimer=null;constructor(o,e,r){super(o),this.plugin=e,this.initialFile=r??null}async onOpen(){this.plugin.activeModal=this,this.renderComponent.load(),this.modalEl.addClass("mpdf-modal"),this.buildUI(this.contentEl);let o=Ie(this.app,this.initialFile);if(o){this.currentFile=o;let e=await this.app.vault.read(o);this.editorEl.value=e,this.noteTitleEl.textContent=o.basename,this.noteTitleEl.title=o.path,this.render(!0)}}onClose(){this.renderDebounceTimer!==null&&(window.clearTimeout(this.renderDebounceTimer),this.renderDebounceTimer=null),this.renderComponent.unload(),this.plugin.activeModal=null,this.currentFile=null,this.layoutCache=null}buildUI(o){let e=this.plugin.settings;this.buildTopbar(o.createEl("div",{cls:"mpdf-topbar"}),e);let r=o.createEl("div",{cls:"mpdf-main"}),i=r.createEl("div",{cls:"mpdf-editor-panel"});this.editorEl=i.createEl("textarea",{cls:"mpdf-editor"}),this.editorEl.placeholder=`Type or paste markdown here to preview and export as PDF.
...
`)}async doRender(o){let e=this.plugin.settings,r=me(this.editorEl.value);e.hideFrontmatter&&(r=ge(r)),e.includeFilenameAsTitle&&this.currentFile&&(r=`# ${this.currentFile.basename}

${r}`),r=t.insertAutoBreaks(r,e.autoBreakH1,e.autoBreakH2);let i=he(r),s=se(e),l=e.orientation==="landscape"?s.h:s.w,a=e.orientation==="landscape"?s.w:s.h,n=P(e.marginTop),c=P(e.marginBottom),p=P(e.marginLeft),h=P(e.marginRight),u=e.showFooter&&(e.showPageNumbers||e.footerText||e.showFooterBorder)?28:0,w=e.showHeader&&(e.headerText||e.showHeaderBorder)?20:0,C=Math.max(1,l-p-h),y=Math.max(1,a-n-c-u-w),E=pe(this.editorEl.value),b=ye(e,E),L=this.currentFile?.path??"pdf-export",M=await Promise.all(i.map(S=>ue(this.app,S,L,this.renderComponent)));if(o!==this.renderToken)return;let f=Te(),g=f?`${f}
${b}`:b,m=[];for(let S of M)m.push(...Oe(S,C,y,g));let x=qe(m,e);this.layoutCache={layouts:x,pw:l,ph:a,mTop:n,mLeft:p,mRight:h,footerH:u,headerH:w,contentW:C,contentH:y,docCSS:g,fontFamily:J(e),accentColor:e.accentColor,pageBackground:e.pageBackground,isRTL:E},this.drawPreview(this.layoutCache,e.previewScale),this.pageCountEl.textContent=`${x.length} page${x.length!==1?"s":""}`,this.hideLoading()}renderPreviewOnly(){this.layoutCache&&this.drawPreview(this.layoutCache,this.plugin.settings.previewScale)}showLoading(){this.loadingOverlayEl.addClass("mpdf-is-active"),this.renderBtn.disabled=!0,this.renderBtn.textContent="Rendering\u2026"}hideLoading(){this.loadingOverlayEl.removeClass("mpdf-is-active"),this.renderBtn.disabled=!1,this.renderBtn.textContent="\u27F3 Render PDF"}drawPreview(o,e){let{layouts:r,pw:i,ph:s,mTop:l,mLeft:a,mRight:n,footerH:c,headerH:p,contentW:h,docCSS:u,fontFamily:w,accentColor:C,pageBackground:y,isRTL:E}=o,b=this.plugin.settings;this.previewEl.empty();let L=new Map;r.forEach((m,x)=>{for(let S of m.pageNodes)S.querySelectorAll("[id]").forEach(T=>{L.has(T.id)||L.set(T.id,x)}),S.id&&!L.has(S.id)&&L.set(S.id,x)});let M=[],f=`
      :host {
        display: block;
        width: ${i}px;
        height: ${s}px;
      ...
      *, *::before, *::after { box-sizing: border-box; }
      ...
      ${u}
    `,g=new CSSStyleSheet;g.replaceSync(f);for(let m of r){let x=Math.round(i*e),S=Math.round(s*e),T=this.previewEl.createEl("div",{cls:"mpdf-page-wrap"});T.setCssStyles({width:`${x}px`,height:`${S}px`}),T.createEl("div",{cls:"mpdf-page-label",text:`Page ${m.pageNum} of ${m.totalPages}`}),M.push(T);let H=T.createEl("div",{cls:"mpdf-page-scale"});H.setCssStyles({width:`${x}px`,height:`${S}px`});let k=activeDocument.createElement("div");k.addClass("mpdf-shadow-host"),k.setCssStyles({width:`${i}px`,height:`${s}px`,transform:`scale(${e})`}),H.appendChild(k);let F=k.attachShadow({mode:"open"});F.adoptedStyleSheets=[g];let D=b.showHeaderFooterOnFirstPage||m.pageNum>1;if(b.showHeader&&D&&(m.headerLeft||m.headerCenter||m.headerRight||b.showHeaderBorder)){let v=activeDocument.createElement("div");v.setCssStyles({position:"absolute",top:`${l*.4}px`,left:`${a}px`,right:`${n}px`,display:"flex",alignItems:"center",fontSize:"9px",color:"#999",fontFamily:w,whiteSpace:"nowrap",...b.showHeaderBorder?{borderBottom:`0.5px solid ${C}33`}:{}}),Y(v,m.headerCenter,m.headerLeft,m.headerRight),F.appendChild(v)}let B=activeDocument.createElement("div");B.className="mpdf-doc",E&&B.setAttribute("dir","rtl"),B.setCssStyles({position:"absolute",top:`${l+p}px`,left:`${a}px`,width:`${h}px`});for(let v of m.pageNodes)B.appendChild(v.cloneNode(!0));if(F.appendChild(B),B.querySelectorAll("a[href^='#']").forEach(v=>{let Q=decodeURIComponent(v.getAttribute("href").slice(1)),I=L.get(Q);I!==void 0&&(v.title=`Go to page ${I+1}`,v.addEventListener("click",ee=>{ee.preventDefault(),M[I]?.scrollIntoView({behavior:"smooth",block:"start"})}))}),b.showFooter&&D&&(m.footerLeft||m.footerRight||m.footerCenter||b.showFooterBorder)){let v=activeDocument.createElement("div");v.setCssStyles({position:"absolute",bottom:"0",left:"0",right:"0",height:`${c}px`,display:"flex",alignItems:"center",...b.showFooterBorder?{borderTop:`0.5px solid ${C}33`}:{},padding:`0 ${n}px 0 ${a}px`,fontSize:"9px",color:"#aaa",fontFamily:w}),Y(v,m.footerCenter,m.footerLeft,m.footerRight),F.appendChild(v)}}}async exportPDF(){let o=this.plugin.settings;this.exportBtn.disabled=!0,this.exportBtn.textContent="\u2B07 Exporting\u2026";let e=()=>{this.exportBtn.disabled=!1,this.exportBtn.textContent="\u2B07 Export PDF"};if(!this.layoutCache){this.renderDebounceTimer!==null&&(window.clearTimeout(this.renderDebounceTimer),this.renderDebounceTimer=null);let g=++this.renderToken;this.showLoading();try{await this.doRender(g)}catch(m){let x=m instanceof Error?m.message:String(m);new d.Notice("Render error: "+x),this.hideLoading(),e();return}}let r=this.layoutCache;if(!r||r.layouts.length===0){new d.Notice("Nothing to export."),e();return}let{layouts:i,pw:s,ph:l,mTop:a,mLeft:n,mRight:c,footerH:p,headerH:h,contentW:u,docCSS:w,fontFamily:C,accentColor:y,pageBackground:E,isRTL:b}=r,L=i.map(g=>{let m=g.pageNodes.map(B=>{let q=B.cloneNode(!0);return q.querySelectorAll("style, script").forEach(v=>{v.closest("svg")||v.remove()}),q.outerHTML}).join(`
`),x=o.showHeaderFooterOnFirstPage||g.pageNum>1,S=o.showHeader&&x&&(g.headerLeft||g.headerCenter||g.headerRight||o.showHeaderBorder),T=o.showHeaderBorder?`border-bottom:0.5px solid ${y}33;`:"",H=S?`<div style="position:absolute;top:${a*.4}px;left:${n}px;right:${c}px;display:flex;align-items:center;font-size:9px;color:#999;font-family:${C};white-space:nowrap;${T}">${Z(g.headerCenter,g.headerLeft,g.headerRight)}</div>`:"",k=o.showFooter&&x&&(g.footerLeft||g.footerRight||g.footerCenter||o.showFooterBorder),F=o.showFooterBorder?`border-top:0.5px solid ${y}33;`:"",D=k?`<div style="position:absolute;bottom:0;left:0;right:0;height:${p}px;display:flex;align-items:center;${F}padding:0 ${c}px 0 ${n}px;font-size:9px;color:#aaa;font-family:${C};">${Z(g.footerCenter,g.footerLeft,g.footerRight)}</div>`:"",N=`<div class="mpdf-doc"${b?' dir="rtl"':""} style="position:absolute;top:${a+h}px;left:${n}px;width:${u}px;">${m}</div>`;return`<div class="mpdf-export-page">${H}${N}${D}</div>`}),M=`
